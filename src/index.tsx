...
const getQuilt = (pattern: string, color: Color | undefined, rows: bigint): Quilt => {
  switch (pattern) {
    case "A": return PatternA(rows,color || GREEN);
    case "B": return PatternB(rows, color || GREEN);
    case "C": return PatternC(rows, color || GREEN);
    case "D": return PatternD(rows, color || GREEN);
    case "E": return PatternE(rows, color || GREEN);
...
if (pattern === undefined) {
  ...
  try {
    ...
    const result = getQuilt(pattern, color, rows);
